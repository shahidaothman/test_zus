  ...
  <div class="auth-wrapper auth-v1">
    <div class="auth-inner">
      <v-card class="auth-card">
        ...
        <v-card-text>
          <v-form>
            <v-text-field v-model="formdata.name" outlined label="Name" placeholder="JohnDoe" hide-details
            ...
            <v-btn block color="primary" class="mt-6" @click="handleFormSubmit"> Sign Up </v-btn>
          </v-form>
        </v-card-text>
  ...
  methods: {
    ...
    .then(function(response){
      if (response.status == 201) {
        // console.log("haree")
        self.$router.push({name: 'pages-login'});
